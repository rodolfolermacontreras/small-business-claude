...
description: "Use when working on Windows, macOS, and Linux portability for paths, line endings, encodings, subprocesses, and signals."
...
Windows, macOS, and Linux portability for paths, line endings, encodings, subprocesses, and signals.
