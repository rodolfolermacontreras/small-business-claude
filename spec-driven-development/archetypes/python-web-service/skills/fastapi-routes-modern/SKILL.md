---
name: fastapi-routes-modern
description: "Use when working on FastAPI route conventions with Pydantic v2 schemas, dependency injection, typed responses, and thin handlers."
argument-hint: "What should this skill help design, implement, or review?"
license: MIT
metadata:
  author: rodolfolermacontreras
  version: '1.0'
  archetype: python-web-service
---

# Fastapi Routes Modern

FastAPI route conventions with Pydantic v2 schemas, dependency injection, typed responses, and thin handlers.
