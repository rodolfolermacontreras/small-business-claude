...
description: "Use when working on pytest and httpx patterns for API integration and contract tests."
...
pytest and httpx patterns for API integration and contract tests.
